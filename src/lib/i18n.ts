...
const translations: Translations = {
  ...
  trendSpotter: {
    ...
    or: 'ଟ୍ରେଣ୍ଡ ସ୍ପଟର',
    ur: 'ٹرینڈ سپاٹر',
    es: 'Detector de Tendencias',
    fr: 'Détecteur de Tendances',
    de: 'Trend-Spotter',
    zh: '趋势发现者',
    ja: 'トレンドスポッター',
    ar: 'كاشف الاتجاهات',
    pt: 'Detector de Tendências',
    ru: 'Обнаружитель Трендов',
    it: 'Rilevatore di Tendenze',
    ko: '트렌드 스포터',
    nl: 'Trendspotter',
    sv: 'Trendspanare',
    da: 'Trendspotter',
    ...
    pl: 'Wykrywacz Trendów',
    tr: 'Trend Bulucu',
    th: 'ผู้ค้นหาเทรนด์',
    vi: 'Người Phát Hiện Xu Hướng',
  },
  trendSpotterDesc: {
    ...
    gu: "પરંપરાગત હસ્તકલાને આધુનિક સ્વાદ અને બજાર વલણોને અનુરૂપ બનાવવા માટે AI-સંચાલિત વિચારો મેળવો.",
    mr: "पारंपारिक हस्तकलांना आधुनिक चव आणि बाजार ट्रेंडशी जुळवून घेण्यासाठी AI-चालित कल्पना मिळवा.",
    kn: "ಸಾಂಪ್ರದಾಯಿಕ ಕರಕುಶಲತೆಯನ್ನು ಆಧುನಿಕ ಅಭಿರುಚಿಗಳು ಮತ್ತು ಮಾರುಕಟ್ಟೆ ಪ್ರವೃತ್ತಿಗಳಿಗೆ ಹೊಂದಿಸಲು AI-ಚಾಲಿತ ಆಲೋಚನೆಗಳನ್ನು ಪಡೆಯಿರಿ.",
    ml: "പരമ്പരാഗത കരകൗശലങ്ങളെ ആധുനിക അഭിരുചികളിലേക്കും വിപണി പ്രവണതകളിലേക്കും പൊരുത്തപ്പെടുത്താൻ AI-പവർഡ് ആശയങ്ങൾ നേടുക.",
    pa: "ਰਵਾਇਤੀ ਸ਼ਿਲਪਕਾਰੀ ਨੂੰ ਆਧੁਨਿਕ ਸਵਾਦ ਅਤੇ ਮਾਰਕੀਟ ਰੁਝਾਨਾਂ ਨਾਲ ਅਨੁਕੂਲ ਬਣਾਉਣ ਲਈ AI-ਸੰਚਾਲਿਤ ਵਿਚਾਰ ਪ੍ਰਾਪਤ ਕਰੋ.",
    as: "পৰম্পৰাগত হস্তশিল্পক আধুনিক ৰুচি আৰু বজাৰৰ প্ৰৱণতাৰ সৈতে খাপ খুৱাবলৈ AI-চালিত ধাৰণা লাভ কৰক.",
    or: "ପାରମ୍ପରିକ ହସ୍ତଶିଳ୍ପକୁ ଆଧୁନିକ ସ୍ୱାଦ ଏବଂ ବଜାର ଧାରାକୁ ଅନୁକୂଳ କରିବା ପାଇଁ AI-ଚାଳିତ ଧାରଣା ପ୍ରାପ୍ତ କରନ୍ତୁ.",
    ur: "روایتی دستکاری کو جدید ذوق اور مارکیٹ کے رجحانات کے مطابق بنانے کے لیے AI سے چلنے والے خیالات حاصل کریں۔",
    es: "Obtenga ideas impulsadas por IA para adaptar las artesanías tradicionales a los gustos modernos y las tendencias del mercado.",
    fr: "Obtenez des idées alimentées par l'IA pour adapter l'artisanat traditionnel aux goûts modernes et aux tendances du marché.",
    de: "Erhalten Sie KI-gestützte Ideen, um traditionelles Handwerk an moderne Geschmäcker und Markttrends anzupassen.",
    zh: "获取AI驱动的想法，将传统工艺适应现代品味和市场趋势。",
    ja: "伝統工芸を現代の好みや市場トレンドに適応させるためのAI駆動のアイデアを取得します。",
    ar: "احصل على أفكار مدعومة بالذكاء الاصطناعي لتكييف الحرف التقليدية مع الأذواق الحديثة واتجاهات السوق.",
    pt: "Obtenha ideias alimentadas por IA para adaptar artesanatos tradicionais aos gostos modernos e tendências de mercado.",
    ru: "Получите идеи на основе ИИ для адаптации традиционных ремесел к современным вкусам и рыночным тенденциям.",
    it: "Ottieni idee alimentate dall'IA per adattare l'artigianato tradizionale ai gusti moderni e alle tendenze di mercato.",
    ko: "전통 공예를 현대적 취향과 시장 트렌드에 맞추기 위한 AI 기반 아이디어를 얻으세요.",
    nl: "Krijg AI-aangedreven ideeën om traditioneel ambacht aan te passen aan moderne smaken en markttrends.",
    sv: "Få AI-drivna idéer för att anpassa traditionellt hantverk till moderna smaker och marknadstrender.",
    da: "Få AI-drevne ideer til at tilpasse traditionelt håndværk til moderne smag og markedstendenser.",
    no: "Få AI-drevne ideer for å tilpasse tradisjonelt håndverk til moderne smaker og markedstrender.",
    fi: "Hanki tekoälyn avulla ideoita perinteisen käsityön mukauttamiseksi nykyaikaisiin makuihin ja markkinatrendeihin.",
    pl: "Uzyskaj pomysły napędzane przez AI, aby dostosować tradycyjne rzemiosło do nowoczesnych gustów i trendów rynkowych.",
    tr: "Geleneksel el sanatlarını modern zevklere ve pazar trendlerine uyarlamak için yapay zeka destekli fikirler edinin.",
    th: "รับแนวคิดที่ขับเคลื่อนด้วย AI เพื่อปรับงานฝีมือแบบดั้งเดิมให้เข้ากับรสนิยมสมัยใหม่และแนวโน้มตลาด",
    vi: "Nhận ý tưởng được hỗ trợ bởi AI để điều chỉnh nghề thủ công truyền thống theo khẩu vị hiện đại và xu hướng thị trường.",
  },
  buyerConnect: {
    en: 'Buyer Connect',
    hi: 'क्रेता कनेक्ट',
