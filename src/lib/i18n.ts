...
const translations: Translations = {
  ...
  welcome: {
    ...
    gu: 'કલામિત્રમાં આપનું સ્વાગત છે. આપની કળાને શક્તિશાળી બનાવવા માટે આપના સાધનો અહીં આપવામાં આવ્યા છે.',
    mr: 'कलामित्रमध्ये आपले स्वागत आहे. आपल्या कलेचे सशक्तीकरण करण्यासाठी आपली साधने येथे आहेत.',
    kn: 'ಕಲಾಮಿತ್ರಕ್ಕೆ ಸ್ವಾಗತ. ನಿಮ್ಮ ಕಲೆಯನ್ನು ಶಕ್ತಿಗೊಳಿಸಲು ನಿಮ್ಮ ಸಾಧನಗಳು ಇಲ್ಲಿವೆ.',
    ml: 'കലാമിത്രയിലേക്ക് സ്വാഗതം. നിങ്ങളുടെ കലയെ ശക്തിപ്പെടുത്തുന്നതിന് നിങ്ങളുടെ ഉപകരണങ്ങൾ ഇവിടെയുണ്ട്.',
    pa: 'ਕਲਾਮਿਤਰ ਵਿੱਚ ਤੁਹਾਡਾ ਸਵਾਗਤ ਹੈ। ਤੁਹਾਡੀ ਕਲਾ ਨੂੰ ਸ਼ਕਤੀਸ਼ਾਲੀ ਬਣਾਉਣ ਲਈ ਤੁਹਾਡੇ ਸੰਦ ਇੱਥੇ ਦਿੱਤੇ ਗਏ ਹਨ।',
    as: 'কলামিত্ৰত আপোনাক স্বাগত। আপোনাৰ শিল্পক শক্তিশালী কৰাৰ বাবে আপোনাৰ সঁজুলি ইয়াত আছে।',
    or: 'କଲାମିତ୍ରରେ ଆପଣଙ୍କର ସ୍ଵାଗତ। ଆପଣଙ୍କର କଳାକୁ ଶକ୍ତିଶାଳୀ କରିବା ପାଇଁ ଆପଣଙ୍କର ଉପକରଣଗୁଡ଼ିକ ଏଠାରେ ଅଛି।',
    ur: 'کالا میتر میں خوش آمدید۔ اپنی کला کو طاقتور بنانے کے لیے آپ کے اوزار یہاں ہیں۔',
    es: 'Bienvenido a KalaMitra. Aquí están tus herramientas para empoderar tu artesanía.',
    fr: 'Bienvenue sur KalaMitra. Voici vos outils pour renforcer votre artisanat.',
    de: 'Willkommen bei KalaMitra. Hier sind Ihre Werkzeuge, um Ihr Handwerk zu stärken.',
    zh: '欢迎来到KalaMitra。这里是您的工具，帮助您赋能您的工艺。',
    ja: 'KalaMitraへようこそ。ここにあなたの工芸を強化するためのツールがあります。',
    ar: 'مرحبا بك في كالاميترا. إليك أدواتك لتمكين حرفك.',
    pt: 'Bem-vindo ao KalaMitra. Aqui estão suas ferramentas para capacitar sua arte.',
    ru: 'Добро пожаловать в KalaMitra. Вот ваши инструменты для укрепления вашего ремесла.',
    it: 'Benvenuto su KalaMitra. Ecco i tuoi strumenti per potenziare la tua arte.',
    ko: 'KalaMitra에 오신 것을 환영합니다. 여기에서 당신의 공예를 강화할 도구가 있습니다.',
    nl: 'Welkom bij KalaMitra. Hier zijn uw tools om uw ambacht te versterken.',
    sv: 'Välkommen till KalaMitra. Här är dina verktyg för att stärka ditt hantverk.',
    da: 'Velkommen til KalaMitra. Her er dine værktøjer til at styrke dit håndværk.',
    no: 'Velkommen til KalaMitra. Her er verktøyene dine for å styrke håndverket ditt.',
    fi: 'Tervetuloa KalaMitraan. Tässä ovat työkalusi käsityösi vahvistamiseksi.',
    pl: 'Witamy w KalaMitra. Oto twoje narzędzia do wzmocnienia rzemiosła.',
    tr: 'KalaMitra\'ya hoş geldiniz. Zanaatinizi güçlendirmek için araçlarınız burada.',
    th: 'ยินดีต้อนรับสู่ KalaMitra นี่คือเครื่องมือของคุณในการเสริมพลังงานฝีมือของคุณ',
    vi: 'Chào mừng bạn đến với KalaMitra. Đây là các công cụ của bạn để trao quyền cho nghệ thuật của bạn.',
  },
  open: {
    en: 'Open',
    hi: 'खोलें',
