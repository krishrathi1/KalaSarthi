...
graph TD
    ...
    QUICK_ACCESS --> CREATOR[Product Creator Agent]
...
- **Quick Access Agent** → **Inventory Dashboard Agent**, **Finance Services Agent**, **Trend Spotter Agent**, **Product Creator Agent**, **Voice Assistant Agent**, **Yojana Mitra Agent**
