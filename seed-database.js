 ...
 * Creates 10 artisans and 10 buyers with complete profiles
 */
...
const artisanProfiles = [
  {
    ...
    description: 'Master potter with 15+ years of experience in traditional Indian ceramics. Specializes in terracotta and glazed pottery.',
    ...
    artisanConnectProfile: {
      ...
      skillTags: [
        ...
        { skill: 'firing', proficiency: 'expert', yearsOfExperience: 15 }
      ],
      portfolioHighlights: [
        'Traditional Khurja pottery',
      ...
      culturalAuthenticity: {
        traditionalTechniques: ['wheel throwing', 'natural glazing', 'wood firing'],
  ...
  },
  {
    ...
    description: 'Expert handloom weaver specializing in Banarasi silk and cotton textiles with traditional patterns.',
    ...
    artisanConnectProfile: {
      specializations: ['handloom', 'silk weaving', 'cotton textiles', 'traditional patterns'],
      skillTags: [
        ...
        { skill: 'pattern design', proficiency: 'expert', yearsOfExperience: 12 }
      ],
      portfolioHighlights: [
      ...
      culturalAuthenticity: {
        traditionalTechniques: ['handloom weaving', 'natural dyeing', 'brocade work'],
  ...
  },
  {
    ...
    description: 'Traditional silver jewelry craftsman with expertise in Rajasthani designs and modern fusion pieces.',
    ...
    artisanConnectProfile: {
      specializations: ['silver jewelry', 'traditional designs', 'custom pieces', 'stone setting'],
      skillTags: [
        ...
        { skill: 'engraving', proficiency: 'expert', yearsOfExperience: 10 }
      ],
      portfolioHighlights: [
      ...
      culturalAuthenticity: {
        traditionalTechniques: ['silver smithing', 'kundan work', 'meenakari'],
  ...
  },
  {
    ...
    description: 'Master embroiderer specializing in Chikankari and Phulkari work with intricate hand stitching.',
    ...
    artisanConnectProfile: {
      specializations: ['chikankari', 'phulkari', 'hand embroidery', 'traditional stitches'],
      skillTags: [
        { skill: 'chikankari', proficiency: 'expert', yearsOfExperience: 20 },
        { skill: 'phulkari', proficiency: 'advanced', yearsOfExperience: 15 },
        { skill: 'hand stitching', proficiency: 'expert', yearsOfExperience: 22 }
      ],
      portfolioHighlights: [
        'Chikankari kurtas and sarees',
        'Phulkari dupattas',
      ...
      culturalAuthenticity: {
        traditionalTechniques: ['chikankari stitches', 'phulkari patterns', 'mirror work'],
  ...
  },
  {
    ...
    description: 'Skilled wood carver specializing in traditional South Indian temple carvings and decorative furniture.',
    ...
    artisanConnectProfile: {
      specializations: ['wood carving', 'temple art', 'furniture', 'decorative panels'],
      skillTags: [
        { skill: 'wood carving', proficiency: 'expert', yearsOfExperience: 16 },
        { skill: 'temple art', proficiency: 'expert', yearsOfExperience: 14 },
        { skill: 'furniture making', proficiency: 'advanced', yearsOfExperience: 12 }
      ],
      portfolioHighlights: [
      ...
      culturalAuthenticity: {
        traditionalTechniques: ['temple carving', 'relief work', 'traditional joinery'],
  ...
  },
  {
    ...
    description: 'Expert in traditional Rajasthani block printing with natural dyes and hand-carved wooden blocks.',
    ...
    artisanConnectProfile: {
      specializations: ['block printing', 'natural dyes', 'textile design', 'hand printing'],
      skillTags: [
        { skill: 'block printing', proficiency: 'expert', yearsOfExperience: 14 },
        { skill: 'natural dyeing', proficiency: 'expert', yearsOfExperience: 12 },
        { skill: 'block carving', proficiency: 'advanced', yearsOfExperience: 10 }
      ],
      portfolioHighlights: [
      ...
      culturalAuthenticity: {
        traditionalTechniques: ['hand block printing', 'natural dyeing', 'resist printing'],
  ...
  },
  {
    ...
    description: 'Traditional metalworker specializing in brass and copper utensils with intricate engravings.',
    ...
    artisanConnectProfile: {
      ...
      culturalAuthenticity: {
        traditionalTechniques: ['brass casting', 'metal engraving', 'traditional finishing'],
  ...
  },
  {
    ...
    description: 'Madhubani and Warli painting artist with expertise in traditional folk art forms.',
    ...
    artisanConnectProfile: {
      specializations: ['madhubani painting', 'warli art', 'folk painting', 'wall art'],
      skillTags: [
        ...
        { skill: 'natural pigments', proficiency: 'expert', yearsOfExperience: 14 }
      ],
      portfolioHighlights: [
        'Traditional Madhubani paintings',
        'Warli wall art',
        'Custom folk art pieces'
      ],
      availabilityStatus: 'available',
      ...
      culturalAuthenticity: {
        traditionalTechniques: ['natural pigments', 'traditional motifs', 'ritual painting'],
  ...
  },
  {
    ...
    description: 'Traditional glassworker specializing in decorative glass items and custom designs.',
    ...
    artisanConnectProfile: {
      specializations: ['glass blowing', 'decorative glass', 'custom designs', 'glass art'],
      skillTags: [
        { skill: 'glass blowing', proficiency: 'expert', yearsOfExperience: 13 },
        { skill: 'glass cutting', proficiency: 'advanced', yearsOfExperience: 11 },
        { skill: 'decorative work', proficiency: 'expert', yearsOfExperience: 12 }
      ],
      portfolioHighlights: [
      ...
      culturalAuthenticity: {
        traditionalTechniques: ['glass blowing', 'traditional shaping', 'color work'],
  ...
  },
  {
    ...
    description: 'Skilled leather craftsperson specializing in traditional bags, shoes, and decorative items.',
    ...
    artisanConnectProfile: {
      specializations: ['leather bags', 'footwear', 'decorative items', 'custom leather work'],
      skillTags: [
        { skill: 'leather crafting', proficiency: 'expert', yearsOfExperience: 14 },
        { skill: 'bag making', proficiency: 'expert', yearsOfExperience: 12 },
        { skill: 'leather tooling', proficiency: 'advanced', yearsOfExperience: 10 }
      ],
      portfolioHighlights: [
      ...
      culturalAuthenticity: {
        traditionalTechniques: ['hand stitching', 'leather tooling', 'traditional tanning'],
